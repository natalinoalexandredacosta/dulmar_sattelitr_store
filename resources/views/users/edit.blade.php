...
<head>
    ...
    <title>Edit Akun - Dulmar Satellite Store</title>
...
<div class="container">
    ...
    <main class="main-content">
        ...
        <div class="page-header">
            ...
            <p>
                Ubah data akun dan hak akses user.
            </p>
        ...
        <div class="form-card">
            ...
            @if ($user->hasRole('Administrator'))
                ...
                <div class="admin-box">
                    Akun ini adalah Administrator.
                    Hak akses Administrator tidak dapat dikurangi dari halaman ini.
                </div>

            @else

                <div class="info-box">
                    Anda dapat mengubah nama, email,
                    dan hak akses user.
                    Password tidak dapat diubah dari User Management.
                    Jika user ingin mengganti password,
                    gunakan fitur Lupa Password pada halaman login.
                </div>

                <div class="security-info">
                    <strong>Aturan transaksi:</strong><br>

                    <strong>Verifikasi Pembayaran Customer</strong>
                    diberikan kepada petugas yang menjual barang atau
                    mengisi paket dan menerima uang dari customer.
            ...
            >
                ...
                @if (!$user->hasRole('Administrator'))
                    ...
                    <p class="permission-description">
                        Centang permission yang boleh digunakan.
                    ...
                    <div class="permission-section">
                        ...
                        <div class="permission-group permission-group-stock-out">
                                ...
                                <label class="permission-item">
                                    ...
                                    <span>
                                        ...
                                        <small class="permission-note">
                                            Petugas mengonfirmasi bahwa uang
                                            customer sudah diterima.
                                        </small>
                            ...
                            <div class="permission-special-admin">
                            ...
                            <div class="permission-special">
                                ...
                                <label class="permission-item">
                                    ...
                                    <span>
                                        ...
                                        <small class="permission-note">
                                            Petugas yang mengisi paket
                                            mengonfirmasi uang customer
                                            sudah diterima.
                                        </small>
